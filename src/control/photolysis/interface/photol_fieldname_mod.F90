...
CHARACTER(LEN=*), PARAMETER :: fldname_bulk_cloud_fraction =                   &
                                                   'bulk_cloud_fraction'
...
CHARACTER(LEN=*), PARAMETER :: fldname_sw_flux_up = 'sw_flux_up'
CHARACTER(LEN=*), PARAMETER :: fldname_sw_flux_down = 'sw_flux_down'
CHARACTER(LEN=*), PARAMETER :: fldname_cos_sza_um = 'cos_sza_um'
